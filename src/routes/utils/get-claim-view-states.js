...
const getAdminAndRecommenderActions = ({
  ...
  const recommendAction =
    claimIsInCheck && recommendToPay === false && recommendToReject === false
...
const getAdminActionsAvailable = ({
  ...
  const isAdminOrAuthorisorOrRecommender =
    isAdministrator || isAuthoriser || isRecommender
  ...
  const claimIsRecommendedToReject =
  ...
  const { moveToInCheckAction, moveToInCheckForm } =
    getAdminAndAuthoriserAndRecommenderActions({
      isAdminOrAuthorisorOrRecommender,
      claimIsOnHold,
      moveToInCheck
    })
...
const superAdminActions = (
  ...
  const claimIsntPaidOrReadyToPay = ![
  ...
  const updateStatusForm =
    isSuperAdmin && updateStatus === true && claimIsntPaidOrReadyToPay
  ...
  const updateEligiblePiiRedactionForm =
    isSuperAdmin && updateEligiblePiiRedaction === true
